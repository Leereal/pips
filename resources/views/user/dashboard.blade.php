                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-{{$bg}} shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-{{$text}}"><b>{{$settings->currency}}{{
                                        number_format(Auth::user()->account_bal, 2, '.', ',')}}</b></h5>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-{{$bg}} shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-{{$text}}"><b>{{$settings->currency}}{{
                                        number_format(Auth::user()->roi, 2, '.', ',')}}</b></h5>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-{{$bg}} shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-{{$text}}"><b>{{$settings->currency}}{{
                                        number_format(Auth::user()->bonus, 2, '.', ',')}}</b></h5>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="p-3 card bg-{{$bg}} shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1 text-{{$text}}"><b>{{$settings->currency}}{{
                                        number_format(Auth::user()->ref_bonus, 2, '.', ',')}}</b></h5>
                    ...
                    <div class="p-3 card bg-{{$bg}} shadow">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <h5 class="mb-1 text-{{$text}}"><b>{{$settings->currency}}{{
                                        number_format($deposited->count, 2, '.', ',')}}</b></h5>
                                @else
