<?php
header("location: https://flecxa.com");
?>
        ...
        <div class="row align-items-center">
            ...
            <div class="pt-2 mt-4 col-lg-6 col-md-5 mt-sm-0 pt-sm-0">
                <div class="position-relative">
                    <img src="{{ asset('storage/app/public/photos/'.$content->getImage('b9158B','img_path'))}}"
        ...
        <div class="row">
                ...
                <div class="text-center border-0 rounded card">
                    <div class="card-body">
                        <div class="p-3 shadow bg-soft-primary roundedd d-inline-block">
                            <img src="{{ asset('temp/images/icon/key.svg') }}" class="avatar avatar-small" alt="">
                        </div>
                        <div class="mt-4">
                            <h5><a href="javascript:void(0)"
                                    class="text-dark">{{$content->getContent('9HOR1z','title')}}</a></h5>
            ...
            <div class="pt-2 mt-4 col-md-6 col-12">
                <div class="text-center border-0 rounded card">
                    <div class="card-body">
                        <div class="p-3 shadow bg-soft-primary roundedd d-inline-block">
                            <img src="{{ asset('temp/images/icon/locked.svg') }}" class="avatar avatar-small" alt="">
                        </div>
                        <div class="mt-4">
                            <h5><a href="javascript:void(0)"
                                    class="text-dark">{{$content->getContent('7DH2G9','title')}}</a></h5>
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="pb-2 mb-4 text-center section-title">
                    <h4 class="mb-4 title"><span class="text-primary">{{$content->getContent('vr6Xw0','title')}}</span>
                    </h4>
                ...
                <div class="p-4 border-0 rounded-md shadow card pricing-rates business-rate">
                    <div class="p-0 card-body">
                        ...
                        <ul class="pt-3 list-unstyled border-top">
                            ...
                            <li class="mb-0 h6 text-muted"><span class="mr-2 text-primary h5"><i
                                        class="align-middle uil uil-check-circle"></i></span>{{ $settings->currency }}{{
                                $plan->minr }}
                                Minimum return</li>
                            <li class="mb-0 h6 text-muted"><span class="mr-2 text-primary h5"><i
                                        class="align-middle uil uil-check-circle"></i></span>{{ $settings->currency }}{{
                ...
                <div id="single-owl" class="owl-carousel owl-theme">
                    ...
                    <div class="m-2 overflow-hidden border-0 card roundedd">
                        <div class="row align-items-center no-gutters">
                            <div class="col-md-5">
                                <img src="{{ asset('storage/app/public/photos/'.$testimony->picture)}}"
