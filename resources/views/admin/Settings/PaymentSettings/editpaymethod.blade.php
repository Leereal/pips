                    ...
                    <form method="POST" action="{{route('updatemethod')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                @if ($method->name == "Bitcoin" or $method->name == "Ethereum" or $method->name ==
                                "Litecoin" or $method->name == "Stripe" or $method->name == "Paystack" or $method->name
                                == "Paypal" or $method->name == "Bank Transfer")
                                <input type="text" class="form-control bg-{{$bg}} text-{{$text}}" name="name"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" value="{{$method->minimum}}"
                                    class="form-control bg-{{$bg}} text-{{$text}}" name="minimum" id="minamount"
                                    required>
                                <small class="text-{{$text}}">Required but only applies to withdrawal</small>
                            </div>
                            <div class="form-group col-md-6">
                                <h6 class="text-{{$text}}">Maximum Amount</h6>
                                <input type="number" value="{{$method->maximum}}"
                                    class="form-control bg-{{$bg}} text-{{$text}}" name="maximum" id="maxamount"
                                    required>
                                <small class="text-{{$text}}">Required but only applies to withdrawal</small>
                            </div>
                            <div class="form-group col-md-6">
                                <h6 class="text-{{$text}}">Charges</h6>
                                <input type="number" value="{{$method->charges_amount}}"
                                    class="form-control bg-{{$bg}} text-{{$text}}" name="charges" id="charges" required>
                                <small class="text-{{$text}}">Required but only applies to withdrawal</small>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="methodtype" id="methodtype" class="form-control bg-{{$bg}} text-{{$text}}"
                                    required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{$method->img_url}}"
                                    class="form-control bg-{{$bg}} text-{{$text}}" name="url" id="url">
                            </div>
                            {{-- Currency inputs --}}
                            <div class="form-group col-md-6 currency">
                                <h6 class="text-{{$text}}">Bank Name</h6>
                                <input type="text" value="{{$method->bankname}}"
                                    class="form-control bg-{{$bg}} text-{{$text}} currinput" name="bank" id="bank">
                            </div>
                            <div class="form-group col-md-6 currency">
                                <h6 class="text-{{$text}}">Account Name</h6>
                                <input type="text" value="{{$method->account_name}}"
                                    class="form-control bg-{{$bg}} text-{{$text}} currinput" name="account_name"
                                    id="acnt_name">
                            </div>
                            <div class="form-group col-md-6 currency">
                                <h6 class="text-{{$text}}">Account Number</h6>
                                <input type="text" value="{{$method->account_number}}"
                                    class="form-control bg-{{$bg}} text-{{$text}} currinput" name="account_number"
                                    id="acnt_number">
                            </div>
                            <div class="form-group col-md-6 currency">
                                <h6 class="text-{{$text}}">Swift/Other Code</h6>
                                <input type="number" value="{{$method->swift_code}}"
                                    class="form-control bg-{{$bg}} text-{{$text}} currinput" name="swift" id="swift">
                            </div>
                            ...
                            <div class="form-group col-md-6 d-none crypto">
                                ...
                                <input type="text" value="{{$method->wallet_address}}"
                                    class="form-control bg-{{$bg}} text-{{$text}} cryptoinput" name="walletaddress"
                                    id="walletaddress">
                            </div>
                            <div class="form-group col-md-6 d-none crypto">
                                <h6 class="text-{{$text}}">Barcode</h6>
                                <input type="file" name="barcode" id=""
                                    class="form-control bg-{{$bg}} text-{{$text}} cryptoinput">
                                {{-- <input type="text" value="{{$method->barcode}}"
                                    class="form-control bg-{{$bg}} text-{{$text}} cryptoinput" name="barcode"
                                    id="barcode"> --}}
                            </div>
                            <div class="form-group col-md-6 d-none crypto">
                                <h6 class="text-{{$text}}">Wallet Address Network Type</h6>
                                <input type="text" value="{{$method->network}}"
                                    class="form-control bg-{{$bg}} text-{{$text}} cryptoinput" name="wallettype"
                                    id="wallettype">
                            </div>
                            <div class="form-group col-md-6">
                                <h6 class="text-{{$text}}">Status</h6>
                                <select name="status" id="status" class="form-control bg-{{$bg}} text-{{$text}}"
                                    required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="typefor" id="status" class="form-control bg-{{$bg}} text-{{$text}}"
                                    required>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" value="{{$method->duration}}"
                                    class="form-control bg-{{$bg}} text-{{$text}}" name="note"
